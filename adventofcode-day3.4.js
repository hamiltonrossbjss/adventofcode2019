...
//  }
 ...
 var intersection0 = [ '768,0', '994,166', '768,-399', '1126,-399' ];
//  var intersection2 = [];
//  var distances = [];
//  console.log(`intersection0: `, intersection0);

//  intersection0.forEach(element => intersection2.push(element.split(",")));
//  // console.log(`intersection2: `, intersection2);
//  intersection2.forEach(element => distances.push(Math.abs(+element[0]) + Math.abs(+element[1])));
...
//  // console.log(shortest)
 ...
 var wirepath2 = [null];
  ...
  // while(wirepath1[wirepath1.length-1] != intersection0[0]){
    // console.log("3", wirepath1[wirepath1.length-1]);
    // console.log("4", intersection0[0]);
    // console.log(wire1direction);
for (elements = 0; elements < intersection0.length; elements++){
  console.log(elements)
  wire1total = 0;
  wirepath1 = [];
    currentPosition.X = 0;
  currentPosition.Y = 0;
  for (index = 0; index < wire1distance.length; index++) {
    // console.log("1", wirepath1[wirepath1.length-1]);
    // console.log("2", intersection0[0]);
    // console.log("3", intersection0[0] != wirepath1[wirepath1.length-1]);
    switch (wire1direction[index]) {
      case "L":
        for (path = 0; path < wire1distance.length; path++) {
          currentPosition.X = currentPosition.X - 1;
          wirepath1.push(currentPosition.X + "," + currentPosition.Y);
          // console.log(wirepath1[wirepath1.length-1])
          wire1total++;
          if(wirepath1[wirepath1.length-1] == intersection0[elements]){
            console.log(`wire1total: `,wire1total)
          }
          // console.log(wire1total);
        }
        break;
      case "R":
...
for (elements = 0; elements < intersection0.length; elements++){
    ...
    switch (wire2direction[index]) {
      case "L":
        for (path = 0; path < wire2distance[index]; path++) {
          currentPosition.X = currentPosition.X - 1;
          wirepath2.push(currentPosition.X + "," + currentPosition.Y);
          wire2total++;
          if(wirepath2[wirepath2.length-1] == intersection0[elements]){
            console.log(`wire2total: `,wire2total)
          }
        }
        break;
      case "R":
  ...
  // const intersection = wirepath1.filter(element => wirepath2.includes(element));
